  ...
  <aside class="macadam-picture-sidebar">
    ...
    <div class="sidebar-scrollable-content">
      ...
      <div id="macadam-sidebar-info-view">
        ...
        <div class="sidebar-section-details">
          <ul class="macadam-info-list">
            ...
            {if $display_info.created_on and isset($INFO_CREATION_DATE)}
              <li>
                <span class="info-icon">📅</span>
                <span class="info-label">{'Created on'|@translate}:</span>
        ...
        {if isset($rating)}
          <div class="macadam-rating-box">
            <span id="updateRate" class="rating-title">{if isset($rating.USER_RATE)}{'Update your rating'|@translate}{else}{'Rate this photo'|@translate}{/if}</span>
      ...
      <div id="macadam-sidebar-comments-view" style="display: none;">
              ...
              <div id="commentAdd">
                <form method="post" action="{$comment_add.F_ACTION}" id="addComment">
                  {if $comment_add.SHOW_AUTHOR}
                    ...
                    <input type="text" name="author" id="author" value="{$comment_add.AUTHOR}"></p>
                  {/if}
                  {if $comment_add.SHOW_EMAIL}
                    <p><label for="email">{'Email address'|@translate}:</label>
                    <input type="text" name="email" id="email" value="{$comment_add.EMAIL}"></p>
                  {/if}
                  <p><label for="contentid">{'Comment'|@translate}:</label>
                  <textarea name="content" id="contentid" rows="4">{$comment_add.CONTENT}</textarea></p>
                  <p>
        ...
        {else}
          <p class="no-comments-msg">Aucun commentaire pour le moment.</p>
        {/if}
      </div>
